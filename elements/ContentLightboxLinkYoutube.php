...
class ContentLightboxLinkYoutube extends \ContentElement
{
    ...
    {
	$arrData = array();
	$arrData['linkUrl'] = 'http://www.youtube.com/embed/' . $this->youtube;
	$arrData['lbl_css'] = 'lbl_youtube';
	...
	if($this->useImage) {
	    ...
	    if($this->linkTitle) {
	        ...
	        $arrData['linkTitle'] = 'https://www.youtube.com/watch?v=' . $this->youtube;
	    }
	}
